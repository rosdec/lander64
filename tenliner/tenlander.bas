...
3?"{clear}{down*10}{white}":D$(1)="{sh asterisk}":D$(2)="{cm i}":D$(3)="K{up}{left}U":D$(4)="I{down}{left}J":fOI=1TO40:?D$(INT(rN(1)*4+1));:nE
...
9pO781,0:sY59903:?"{home}";CHR$(30+2*(VV>1.5));"vel ";INT(VV*100);CHR$(30+2*(F<5));" fuel ";F;"{white}":gO4
